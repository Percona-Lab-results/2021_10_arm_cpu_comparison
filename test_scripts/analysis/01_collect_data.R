...
print("it is goung to be run next script to get the data")
...
slow_ec2 <- c("t4g.medium", "t4g.large","t3.medium", "t3.large", "m6g.large","m6g.xlarge","m6g.2xlarge","m5.large","m5.xlarge","m5.2xlarge","m5a.large","m5a.xlarge","m5a.2xlarge")
medium_ec2 <- c("m6g.4xlarge","m6g.8xlarge","m5.4xlarge","m5.8xlarge","m5a.4xlarge","m5a.8xlarge")
fast_ec2 <- c("m6g.12xlarge","m6g.16xlarge","m5.12xlarge","m5.16xlarge","m5a.12xlarge","m5a.16xlarge")
...
ec2_dt <- data.table(VM_type=c(  "t4g.medium", "t4g.large","t3.medium", "t3.large",
                                 "m6g.large","m6g.xlarge","m6g.2xlarge",
                                 "m6g.4xlarge","m6g.8xlarge","m6g.12xlarge","m6g.16xlarge","m5.large","m5.xlarge","m5.2xlarge","m5.4xlarge","m5.8xlarge",
                                 "m5.12xlarge","m5.16xlarge","m5a.large","m5a.xlarge","m5a.2xlarge","m5a.4xlarge","m5a.8xlarge","m5a.12xlarge", "m5a.16xlarge"),
                     cpu_amount=c(2,2,2,2,2, 4,8,16,32,48,64,2,4,8,16,32,48,64,2,4,8,16,32,48,64),
                     ram_size_gb=c(4,8,4,8,8,16,32,64,128,192,256,8,16,32,64,128,192,256,8,16,32,64,128,192,256),
                     price_usd=c(0.0336 , 0.0672, 0.0418,0.0835, 0.077,0.154,0.308,0.616,1.232,1.848,2.464,0.096,0.192,0.384,0.768,1.536,2.304,3.072, 0.086, 0.172, 0.344,0.688,1.376,2.064,2.752))


oltp_test_result <- oltp_test_result[ec2_dt, on="VM_type"]
oltp_test_result <- oltp_test_result[ec2_type != "-"]
